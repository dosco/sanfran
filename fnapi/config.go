...
func getFnstoreAccessKey() string {
	return getEnv("SANFRAN_FNSTORE_ACCESSKEY", true)
}

func getFnstoreSecretKey() string {
	return getEnv("SANFRAN_FNSTORE_SECRETKEY", true)
}
