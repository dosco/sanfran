...
type GetResp struct {
	...
	CodePath string    `protobuf:"bytes,3,opt,name=code_path,json=codePath,proto3" json:"code_path,omitempty"`
}
...
func (m *GetResp) GetCodePath() string {
	if m != nil {
		return m.CodePath
	}
	return ""
...
func (m *GetResp) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CodePath) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintRpc(dAtA, i, uint64(len(m.CodePath)))
		i += copy(dAtA[i:], m.CodePath)
	}
	return i, nil
}
...
var fileDescriptorRpc = []byte{
	...
	,
}
