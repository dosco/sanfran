...
type ExecuteReq struct {
	...
	Query  map[string]*ListOfString `protobuf:"bytes,4,rep,name=query" json:"query,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	Header map[string]*ListOfString `protobuf:"bytes,5,rep,name=header" json:"header,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
type ExecuteResp struct {
	...
	Header     map[string]*ListOfString `protobuf:"bytes,3,rep,name=header" json:"header,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *MetricsResp) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LastPing != 0 {
		dAtA[i] = 0x21
		i++
		i = encodeFixed64Rpc(dAtA, i, uint64(math.Float64bits(float64(m.LastPing))))
	}
	if m.Terminate {
		dAtA[i] = 0x28
		i++
...
func (m *MetricsReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FromController", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *MetricsResp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastPing", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v |= uint64(dAtA[iNdEx-2]) << 48
			v |= uint64(dAtA[iNdEx-1]) << 56
			m.LastPing = float64(math.Float64frombits(v))
		case 5:
			if wireType != 0 {
...
var fileDescriptorRpc = []byte{
	...
	,
}
